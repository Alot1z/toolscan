...
var let_ = (map12) => dual(3, (self, name, f) => map12(self, (a) => ({
  ...a,
  [name]: f(a)
})));
var bindTo = (map12) => dual(2, (self, name) => map12(self, (a) => ({
  [name]: a
})));
var bind = (map12, flatMap10) => dual(3, (self, name, f) => flatMap10(self, (a) => map12(f(a), (b) => ({
  ...a,
  [name]: b
}))));
...
var EmptyNode = class _EmptyNode {
  _tag = "EmptyNode";
  modify(edit, _shift, f, hash2, key, size9) {
    const v = f(none2());
...
var CollisionNode = class _CollisionNode {
  ...
  modify(edit, shift2, f, hash2, key, size9) {
    if (hash2 === this.hash) {
      ...
      const list = this.updateCollisionList(canEdit, edit, this.hash, this.children, f, key, size9);
  ...
  updateCollisionList(mutate4, edit, hash2, list, f, key, size9) {
...
var ArrayNode = class _ArrayNode {
  ...
  children;
  _tag = "ArrayNode";
  constructor(edit, size9, children) {
    this.edit = edit;
    this.size = size9;
    this.children = children;
  }
  modify(edit, shift2, f, hash2, key, size9) {
    ...
    const newChild = (child || new EmptyNode()).modify(edit, shift2 + SIZE, f, hash2, key, size9);
...
var makeImpl = (editable, edit, root, size9) => {
...
var modifyHash = /* @__PURE__ */ dual(4, (self, key, hash2, f) => {
  ...
  const newRoot = self._root.modify(self._editable ? self._edit : NaN, 0, f, hash2, key, size9);
  return pipe(self, setTree(newRoot, size9.value));
});
var remove2 = /* @__PURE__ */ dual(2, (self, key) => modifyAt(self, key, none2));
var map3 = /* @__PURE__ */ dual(2, (self, f) => reduce2(self, empty5(), (map12, value, key) => set(map12, key, f(value, key))));
...
var diff2 = (oldValue, newValue) => {
  const [removed, patch9] = reduce4([oldValue, empty11()], ([set7, patch10], value) => {
    if (has3(value)(set7)) {
...
var parallelCollectionCombine = (self, that) => new ParallelImpl(reduce5(self.map, that.map, (map12, value, key) => set3(map12, key, match2(get7(map12, key), {
  onNone: () => value,
...
var sequentialCollectionCombine = (self, that) => new SequentialImpl(reduce5(that.map, self.map, (map12, value, key) => set3(map12, key, match2(get7(map12, key), {
  onNone: () => empty4(),
...
var InvalidData = (path7, message, options = {
  pathDelim: "."
}) => {
  const error = Object.create(proto2);
  ...
  Object.defineProperty(error, "toString", {
    enumerable: false,
    value() {
      const path8 = pipe(this.path, join(options.pathDelim));
      return `(Invalid data at ${path8}: "${this.message}")`;
    }
  });
  return error;
};
var MissingData = (path7, message, options = {
  pathDelim: "."
}) => {
  const error = Object.create(proto2);
...
var SourceUnavailable = (path7, message, cause3, options = {
  pathDelim: "."
}) => {
  const error = Object.create(proto2);
...
var Unsupported = (path7, message, options = {
  pathDelim: "."
}) => {
  const error = Object.create(proto2);
...
var makeFlat = (options) => ({
  ...
  patch: options.patch,
  load: (path7, config, split = true) => options.load(path7, config, split),
...
var fromEnv = (options) => {
  ...
  const load = (path7, primitive, split = true) => {
    const pathString = makePathString(path7);
    const current = getEnv();
    const valueOpt = pathString in current ? some2(current[pathString]) : none2();
    return pipe(valueOpt, mapError(() => MissingData(path7, `Expected ${pathString} to exist in the process context`)), flatMap7((value) => parsePrimitive(value, path7, primitive, seqDelim, split)));
  };
...
var appendConfigPath = (path7, config) => {
  let op = config;
  if (op._tag === "Nested") {
...
var RedactedConfigErrorReducer = {
  ...
  invalidDataCase: (_, path7) => InvalidData(path7, "<redacted>"),
  missingDataCase: (_, path7) => MissingData(path7, "<redacted>"),
  sourceUnavailableCase: (_, path7, _message, cause3) => SourceUnavailable(path7, "<redacted>", cause3),
  unsupportedCase: (_, path7) => Unsupported(path7, "<redacted>")
};
    ...
    case OP_ZIP_WITH: {
      return suspend(() => pipe(fromFlatLoop(flat, prefix, op.left, split), either2, flatMap7((left3) => pipe(fromFlatLoop(flat, prefix, op.right, split), either2, flatMap7((right3) => {
        ...
        if (isRight2(left3) && isRight2(right3)) {
          ...
          const fail6 = fromFlatLoopFail(prefix, path7);
...
var parsePrimitive = (text, path7, primitive, delimiter, split) => {
  if (!split) {
  ...
  return pipe(splitPathString(text, delimiter), forEachSequential((char) => primitive.parse(char.trim())), mapError(prefixed(path7)));
};
...
var unsafeForkAs = (self, map12, fiberId3) => {
  self.locals.forEach((stack, fiberRef) => {
    ...
    if (equals(oldValue, newValue)) {
      ...
      map12.set(fiberRef, [[fiberId3, newValue], ...stack]);
    }
  });
};
...
var head3 = (self) => flatMap7(self, (as4) => {
...
var tryPromise = (arg) => {
  ...
  const fail6 = (e) => catcher ? failSync(() => catcher(e)) : fail2(new UnknownException(e, "An unknown error occurred in Effect.tryPromise"));
  if (evaluate2.length >= 1) {
    return async_((resolve, signal) => {
      try {
        evaluate2(signal).then((a) => resolve(succeed(a)), (e) => resolve(fail6(e)));
      } catch (e) {
        resolve(fail6(e));
      }
    });
  ...
  return async_((resolve) => {
    try {
      evaluate2().then((a) => resolve(succeed(a)), (e) => resolve(fail6(e)));
    } catch (e) {
      resolve(fail6(e));
    }
  });
...
var histogram4 = (key) => {
  ...
  const size9 = bounds.length;
  const values3 = new Uint32Array(size9 + 1);
  const boundaries = new Float64Array(size9);
  let count = 0;
  let sum2 = 0;
...
var forEachParUnbounded = (self, f, batching) => suspend(() => {
  ...
  return zipRight(forEachConcurrentDiscard(as4, fn2, batching, false), succeed(array3));
});
...
var forEachParN = (self, n, f, batching) => suspend(() => {
  ...
  return zipRight(forEachConcurrentDiscard(as4, fn2, batching, false, n), succeed(array3));
});
...
var CacheImpl = class {
  ...
  trackAccess(key) {
    ...
    if (compareAndSet(this.cacheState.updating, false, true)) {
      ...
      let size9 = size4(this.cacheState.map);
      loop3 = size9 > this.capacity;
      while (loop3) {
...
var cachedFunction = (f, eq) => {
  return pipe(sync(() => empty17()), flatMap7(makeSynchronized), map8((ref) => (a) => pipe(ref.modifyEffect((map12) => {
    const result = pipe(map12, get8(new Key(a, eq)));
    if (isNone2(result)) {
      return pipe(deferredMake(), tap((deferred) => pipe(diffFiberRefs(f(a)), intoDeferred(deferred), fork)), map8((deferred) => [deferred, pipe(map12, set4(new Key(a, eq), deferred))]));
    }
      ...
      return pipe(make26(0), flatMap7((observers) => pipe(deferredMake(), flatMap7((deferred) => pipe(make26(() => void_), map8((finalizerRef) => {
        const resource = uninterruptibleMask((restore) => pipe(scopeMake(), flatMap7((innerScope) => pipe(restore(flatMap7(makeBuilder(layer, innerScope, true), (f) => diffFiberRefs(f(this)))), exit, flatMap7((exit4) => {
          switch (exit4._tag) {
            ...
            case OP_SUCCESS: {
              return pipe(set5(finalizerRef, (exit5) => pipe(scopeClose(innerScope, exit5), whenEffect(modify3(observers, (n) => [n === 1, n - 1])), asVoid)), zipRight(update2(observers, (n) => n + 1)), zipRight(scopeAddFinalizerExit(scope3, (exit5) => pipe(sync(() => map12.delete(layer)), zipRight(get11(finalizerRef)), flatMap7((finalizer) => finalizer(exit5))))), zipRight(deferredSucceed(deferred, exit4.effect_instruction_i0)), as(exit4.effect_instruction_i0[1]));
            }
          }
        })))));
...
var asVoid2 = (self) => map10(self, constVoid);
...
var MOVE_HASH_MAX_BYTES = 2 * 1024 * 1024;
function extSet(platform, env) {
...
var takeBudget = (ref, maxFiles) => Effect_exports.gen(function* () {
  const s = yield* Ref_exports.get(ref);
  if (s.files > maxFiles) {
    yield* Ref_exports.set(ref, { ...s, truncated: true });
    return false;
  }
  yield* Ref_exports.update(ref, (x) => ({ ...x, files: x.files + 1 }));
  return true;
});
var scanPathDir = (dir, ex, ref, maxFiles, filter6, sink) => Effect_exports.gen(function* () {
  let items;
  try {
  ...
  for (const it of items) {
    ...
    if (isExecutable(full, ex) && filter6(name)) sink(name, full, "PATH");
  }
});
var scanOneRoot = (root, ex, ref, maxFiles, maxDepth, filter6) => Effect_exports.gen(function* () {
  const tools = /* @__PURE__ */ new Map();
  const queue = [[root, 0]];
  while (queue.length) {
    if ((yield* Ref_exports.get(ref)).truncated) return tools;
    ...
    for (const it of items) {
      ...
      if (it.isDirectory()) {
        ...
        const name = toolName(full, ex);
        if (!tools.has(name) && isExecutable(full, ex) && filter6(name)) {
...
function scan(opts = {}) {
  ...
  const filter6 = nameFilter(opts.name);
  const started = Date.now();
  return Effect_exports.gen(function* () {
    const ref = yield* Ref_exports.make({ files: 0, truncated: false });
    const tools = /* @__PURE__ */ new Map();
    let pathEntries = 0;
    if (!opts.noPath) {
      for (const dir of (env.PATH || "").split(platform === "win32" ? ";" : ":")) {
        ...
        pathEntries += 1;
        yield* scanPathDir(dir, ex, ref, maxFiles, filter6, (name, fullPath, source) => {
          if (!tools.has(name)) tools.set(name, { name, path: fullPath, source });
        });
      }
    }
    if (!opts.noRoots && Date.now() - started <= maxMs) {
      const roots = (opts.roots && opts.roots.length > 0 ? opts.roots : defaultRoots(platform, env)).map((r) => expandHome(r, env)).filter(Boolean);
      const maps = yield* Effect_exports.forEach(
        roots,
        (root) => scanOneRoot(root, ex, ref, maxFiles, depth, filter6),
        { concurrency: "unbounded" }
      );
      for (const map12 of maps) {
        for (const [name, entry] of map12) {
          if (!tools.has(name)) tools.set(name, entry);
        }
      }
    }
    const { truncated } = yield* Ref_exports.get(ref);
    return {
      ok: true,
...
var MACHINE_PREFIX_FALLBACK = [
  "C:\\Program Files",
  "C:\\Program Files (x86)",
  "C:\\ProgramData",
  "C:\\Windows"
];
function machinePrefixes(env) {
  const derived = [
    env.ProgramFiles,
...
function existsCaseInsensitive(dir) {
  if (fs3.existsSync(dir)) return true;
  if (process.platform !== "win32") return false;
  const parent = dir.replace(/[\\/]+$/, "").replace(/[\\/][^\\/]+$/, "");
  const base = dir.slice(parent.length + 1).toLowerCase();
  try {
    return fs3.readdirSync(parent).some((e) => e.toLowerCase() === base);
  } catch {
    return false;
  }
}
...
// src/shadowed.ts
var SEP = (platform) => platform === "win32" ? ";" : ":";
function shadowedNames(report, platform, env) {
  const provider = providerFor(platform);
  const ex = extSet(platform, env);
  const byName = /* @__PURE__ */ new Map();
  const dirs = (env.PATH ?? "").split(SEP(platform)).map((d) => d.trim()).filter(Boolean);
  for (const rawDir of dirs) {
    ...
    for (const it of items) {
      if (it.isDirectory() || it.isSymbolicLink()) continue;
      const full = path5.join(dir, it.name);
...
function writeSnapshot(file, snapshot) {
  fs5.writeFileSync(file, `${JSON.stringify(snapshot, null, 2)}
`, "utf8");
}
function diffTools(a, b, options = {}) {
  ...
  const removed = [];
  const changed = [];
  for (const [name, path7] of bm) {
    if (!am.has(name)) added.push({ name, path: path7 });
  }
  for (const [name, path7] of am) {
    if (!bm.has(name)) removed.push({ name, path: path7 });
  }
  for (const [name, to] of bm) {
    const from = am.get(name);
    if (from !== void 0 && from !== to) changed.push({ name, from, to });
  }
  const moved = [];
  if (options.moves) {
    const removedByHash = /* @__PURE__ */ new Map();
    ...
    for (const a2 of added) {
      const h = hashLauncher(a2.path);
      const from = h ? removedByHash.get(h) : void 0;
      if (from !== void 0 && from !== a2.name) {
        moved.push({ name: a2.name, from, to: a2.path });
        movedAway.add(from);
      } else {
        keptAdded.push(a2);
      }
...
function parseArgs(argv) {
  ...
  for (const a of argv) {
    ...
    if (command === "scan" && commands.has(a)) command = a;
  ...
  const scanOptions = {
    ...
    depth: Number(value("--depth")) || void 0,
    maxMs: Number(value("--max-ms")) || void 0,
    maxFiles: Number(value("--max-files")) || void 0
  };
  return {
    command,
    positional,
...
async function main(argv = process.argv.slice(2)) {
  ...
  switch (args2.command) {
    ...
    case "check": {
      ...
      if (!args2.quiet) process.stderr.write(`not found: ${name}
`);
      process.exit(1);
      break;
    }
    case "snapshot": {
      const report = await Effect_exports.runPromise(runScan(args2.scanOptions));
      const file = args2.out || path6.join(process.cwd(), "toolscan-snapshot.json");
    ...
    case "diff": {
      const [aFile, bFile] = args2.positional;
      if (!aFile) {
        usage();
        process.exit(2);
      }
      ...
      if (bFile) {
        ...
        b = (await Effect_exports.runPromise(runScan(args2.scanOptions))).tools;
      }
      const out = diffTools(loadSnapshot(aFile).tools, b, { moves: args2.moves });
    ...
    case "missing": {
      ...
      const names = fs6.readFileSync(args2.from, "utf8").split(/[\s,]+/).filter(Boolean);
      const report = await Effect_exports.runPromise(runScan(args2.scanOptions));
    ...
    case "drift": {
      ...
      let baseline;
      try {
        baseline = loadSnapshot(args2.baseline);
      } catch (err) {
        fail5(`drift: cannot read baseline ${args2.baseline}: ${err.message}`, 1);
      }
      const report = await Effect_exports.runPromise(runScan(args2.scanOptions));
      if (report.truncated) {
      ...
      const out = diffTools(baseline.tools, report.tools, { moves: args2.moves });
    ...
    case "verify": {
      ...
      let text;
      try {
        text = fs6.readFileSync(args2.entries, "utf8");
      } catch (err) {
    ...
    default: {
      ...
      if (args2.shadowed) {
        ...
        const out = shadowedNames(report, process.platform, process.env);
        console.log(JSON.stringify(out, null, 2));
        process.exit(out.ok ? 0 : 1);
        break;
      }
